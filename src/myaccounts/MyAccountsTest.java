...
//1.3 Verify the text “Register Account”
        String actualText = getTextElement(By.xpath("//h1[contains(text(),'Register Account')]"));
...
//3.3 Enter First Name
        sendTextToElement(By.id("input-firstname"), "Sapna");
//3.4 Enter Last Name
        sendTextToElement(By.id("input-lastname"), "Patel");
//3.5 Enter Email
        sendTextToElement(By.id("input-email"),   "sapna56patel@gmail.com");
//3.6 Enter Telephone
        sendTextToElement(By.id("input-telephone"), "07456765443" );
//3.7 Enter Password
